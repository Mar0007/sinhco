...
<div class="row">
    <div class="container">
        ...
        <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
            <a id="btnCrear" href="javascript:OpenModal()" class="btn-floating btn-large blue-grey darken-2 tooltipped" data-position="left" data-delay="50" data-tooltip="Crear Bloque">
...
<div id="datamodal" class="modal create-item modal-fixed-footer">
    <div class="modal-content">
        <h5 style="margin-top:-10px">Crear bloque</h5>        
	...
	$(document).ready(function(){						
		...
		$.ajax({
			...
			function(data)
			{
				if(data == "none")
				{
					$("#datacontainer").append('<li class="DataEmpty center"><p class="center light">No hay bloques disponibles</p></li>');
					return;
				}
				...
				{
					Materialize.toast('Error al traer los bloques', 3000,"red");				
	...
	function Agregar()
	{
		...
		({
			...
			if(data == "0")
			{
				...
				location.href = "crearbloque/"+idbloque ;
			}				
			else
			{
				if(data == "104")
		...
		function()
		{
			$.ajax({
				...
				if(data == "0")
				{
					...
					Materialize.toast('El bloque se borro exitosamente', 3000,"green");					
				}
				else
				{
					Materialize.toast('Error al borrar el bloque', 3000,"red");
