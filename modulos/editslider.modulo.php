        ...
        <div class="" style="height:100%;position:relative">            
            <div id="profile-header" class="content" >
                <?php                                        
                    ...
                    [
                        [
                            "href" 		=> "javascript:CoverModal('%id')",
                            "icon" 		=> "",
                            "contenido" => "Editar slider"                            
                        ],
                        [
                            "href" 		=> "javascript:eliminar('%id')",
                            "icon" 		=> "",
                            "contenido" => "Eliminar slider"                            
                        ]
                    ];                    
                    echo 
                    "
                        ...
                        <div style=\"font-size:2.3rem\" class=\"menu-panel white-text\">"
                                .GetDropDownSettingsRow($IDSlider,$DropDownData)."
                        </div> 
                    ";
                ...
                <div class="description">
                    ...
                    <!--h6 id="sidecontent" class="white-text medium" style="margin-top:4%; padding-left:4%;padding-bottom:1%"><?php //echo $stmtSlider["contenido"] ?></h6-->
                </div>
            </div>
        </div>
    </div>    
...
<script>
    ...
    $(document).ready(function(){        
        ...
        //Add event to FileInpu
        $("#FileInput").change(handleFileSelect);
        
        $.ajax(
            {
                url:"<?php echo GetURL("modulos/modeditslider/serviceeditslider.php?accion=1")?>",
                method: "POST",
    ...
    function Agregar()
    {
        ...
        $.ajax({
                url: "<?php echo GetURL("modulos/modeditslider/serviceeditslider.php?accion=2")?>",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false            
    ...
    function Editar(id)
    {
        ...
        $.ajax({
                url: "<?php echo GetURL("modulos/modeditslider/serviceeditslider.php?accion=3")?>",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false            
    ...
    function DeleteImage(id)
    {
        ...
        function()
        {
            ...
            $.ajax({
                url:"<?php echo GetURL("modulos/modeditslider/serviceeditslider.php?accion=4")?>",
                method: "POST",
	...
	function LoadModulos(id)
	{
		...
		ajax_request = $.ajax({
			url:"<?php echo GetURL("modulos/modeditslider/serviceeditslider.php?accion=5")?>",
			method: "POST",
			dataType: "JSON",
