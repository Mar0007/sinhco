...
defined('LINFO_LOCAL_PATH') or define('LINFO_LOCAL_PATH', "../../recursos/linfo" . '/');

defined('LINFO_CACHE_PATH') or define('LINFO_CACHE_PATH',
	is_writable("../../recursos/linfo" . '/cache/') ? "../../recursos/linfo" . '/cache/' : sys_get_temp_dir() . DIRECTORY_SEPARATOR
);
